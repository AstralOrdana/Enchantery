...
public abstract class TridentChannelingEnchantmentMixin extends Enchantment {
    protected TridentChannelingEnchantmentMixin(Rarity rarity, EnchantmentCategory enchantmentCategory, EquipmentSlot[] equipmentSlots) {
