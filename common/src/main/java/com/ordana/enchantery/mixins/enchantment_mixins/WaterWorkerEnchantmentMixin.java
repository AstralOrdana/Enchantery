...
@Mixin(WaterWorkerEnchantment.class)
public abstract class WaterWorkerEnchantmentMixin extends Enchantment {
    protected WaterWorkerEnchantmentMixin(Rarity rarity, EnchantmentCategory enchantmentCategory, EquipmentSlot[] equipmentSlots) {
