...
public abstract class TridentRiptideEnchantmentMixin extends Enchantment {
    protected TridentRiptideEnchantmentMixin(Rarity rarity, EnchantmentCategory enchantmentCategory, EquipmentSlot[] equipmentSlots) {
