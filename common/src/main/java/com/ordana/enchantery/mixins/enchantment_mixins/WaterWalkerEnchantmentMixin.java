...
public abstract class WaterWalkerEnchantmentMixin extends Enchantment {
    protected WaterWalkerEnchantmentMixin(Rarity rarity, EnchantmentCategory enchantmentCategory, EquipmentSlot[] equipmentSlots) {
